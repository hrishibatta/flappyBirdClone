...
def rotate_bird(bird):
    new_bird = pygame.transform.rotate(bird, -bird_movement)
    return new_bird
...
game_font_large = pygame.font.Font('assets/04B_19.ttf',100)
...
bird_downflap = pygame.transform.scale2x(pygame.image.load('assets/images/bluebird-downflap.png').convert())
bird_midflap = pygame.transform.scale2x(pygame.image.load('assets/images/bluebird-midflap.png').convert())
bird_upflap = pygame.transform.scale2x(pygame.image.load('assets/images/bluebird-upflap.png').convert())
...
while True:
    ...
    clock.tick(120) #insures that frame rate doesn't excede 120 frames per second
